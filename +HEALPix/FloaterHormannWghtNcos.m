%FLOATERHORMANNWGHTNCOS     computes weights necessary evaluate a rational
...
% the weights computed are prod(1/(x_k-x_j)).
% Usage:
%   W_k = FLOATERHORMANNWGHTNCOS(thk,d)
...
function Wk = FloaterHormannWghtNcos(thk, d)
